...
[POWERUSR] = ERGODOX_KEYMAP(
    ...
    _______,   KC_HOME,   _______,   _______,   KC_RIGHT,  _______,
    ...
    _______,   _______,   _______,   _______,   _______,   _______,   _______,
    _______,   KC_PGDOWN, KC_PGUP,   ALL_T(KC_I),_______,  KC_UP,     _______,
               KC_LEFT,   KC_DOWN,   KC_UP,    KC_RIGHT,   _______,   _______,
    _______,   KC_DOWN,   _______,   _______,  LALT(KC_KP_ASTERISK), _______, _______,
               _______,   _______,   _______,   _______,   _______,
                  _______,   _______,
                  _______,
                  _______,   _______,   _______),
